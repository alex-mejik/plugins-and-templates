...
$options = array (
    ...
    array(  "name" => "Welcome message",
            "type" => "title",
			"desc" => "This section customizes the welcome message section on the homepage.",
       		),
	   
	array(    "type" => "open"),
	
	array( 	"name" => "Welcome message",
			"desc" => "Add few lines about the site.",
			"id" => $shortname."_mytxt",
          	"std" => "Few text about my site and me. Configured via theme option page. ",
            "type" => "textarea"),    
			
	array( 	"name" => "Avatar image",
			"desc" => "Enter the image url for avatar",
			"id" => $shortname."_myimg",
          	"std" => " ",
            "type" => "text"),    
	array(    "type" => "close"),	
	...
	array("name" => "Banner-1 Image",
            ...
            "std" => "http://www.themes.org.il/images/banner.jpg",
            "type" => "text"),    
